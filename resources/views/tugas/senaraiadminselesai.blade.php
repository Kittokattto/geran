			...
			<div class="row" >
				<div class="col-md-12 col-sm-12 col-xs-12" >
						...
						<nav class="tab-link" style="margin-left: 8px;">
							...
							<a href="{!! url('/tugas/senarai')!!}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> <span class="visible-xs"></span><i class="fa"></i><b>Senarai Tugas Selesai</b> </a>
							<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-outline-primary shadow-sm"> <span class="visible-xs"></span><i class="fa"></i><b>Senarai Tugas Tidak Selesai</b> </a>
