		...
		<!-- End Modal for Coupon Data -->
                    ...
                    <div class="card mb-4 py-3 border-bottom-secondry">
                        <nav class="tab-link"  style="margin-left: 8px;" >
                            ...
                            <a href="{!! url('/tugas/senarai')!!}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> <span class="visible-xs"></span><i class="fa"></i><b>Senarai Geran</b> </a>
                            <a href="{!! url('/tugas/tambah')!!}" class="d-none d-sm-inline-block btn btn-sm btn-outline-primary shadow-sm"><span class="visible-xs"></span><i class="fa">&nbsp;</i><b>Tambah Geran</b></a>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
						...
						@endif
                                <form id="demo-form2" action="update/{{ $task->id }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask customerAddForm">
                                         @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <input type="text" id="title" name="title" placeholder="{{ $task->title}}" value="{{ $task->title }}" class="form-control" maxlength="25" >
                                                            @if ($errors->has('title'))
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <select name="priority" id="priority" class="form-control" placeholder="" value=""  autocomplete="negeri"   >
                                                            <option value="" disabled selected hidden >Keutamaan</option>
                                                            <option value="1" style="color: rgb(255, 37, 9);" <?php if($task->keutamaan == '1'){ echo "selected"; }?> >High</option>
                                                            <option value="2" style="color: rgb(255, 255, 0);" <?php if($task->keutamaan == '2'){ echo "selected"; }?>>Medium</option>
                                                            <option value="3" style="color: rgb(20, 247, 93);" <?php if($task->keutamaan == '3'){ echo "selected"; }?>>Low</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <select name="staf" id="staf"  class="form-control" value="{{ $task->staff->name }}" aria-placeholder="{{ $task->staff->name }}" autocomplete="tajuk" >
                                                            <option value="{{$task->id_user}}" selected>{{$task->staff->name}}</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <textarea rows="10" cols="40" name="tugas" placeholder="{{ $task->tugas}}" value="{{ $task->tugas }}" class="form-control">{{ $task->tugas}}</textarea>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="date" id="tarikh" name="tarikh" placeholder="{{ $task->tarikh}}" value="{{ $task->tarikh }}" class="form-control" maxlength="25" >
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input class="form-control" type="text" value="{{$days}}" readonly >
                                                    @if ($errors->has('time'))
                                                    <span class="help-block text-danger" >
