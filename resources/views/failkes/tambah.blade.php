		...
		<!-- End Modal for Coupon Data -->
                    ...
                    <div class="card mb-4 py-3 border-bottom-secondry">
                        <nav class="tab-link"  style="margin-left: 8px;" >
                            ...
                            <a href="{!! url('/failkes/senarai')!!}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> <span class="visible-xs"></span><i class="fa"></i><b>Senarai Geran</b> </a>
                            <a href="{!! url('/failkes/tambah')!!}" class="d-none d-sm-inline-block btn btn-sm btn-outline-primary shadow-sm"><span class="visible-xs"></span><i class="fa">&nbsp;</i><b>Tambah Geran</b></a>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
						...
						@endif
                                <form id="demo-form2" action="{!! url('/failkes/store')!!}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask customerAddForm">
                                         @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <input type="text"  name="pemilik" placeholder="{{ trans('Pemilik')}}" value="{{ old('pemilik') }}" class="form-control" maxlength="25" >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">  
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <input type="text"  name="no_fail" placeholder="{{ trans('No. Fail')}}" value="{{ old('syano_failrat') }}" class="form-control" maxlength="25" >
                                            ...
                                            <div class="row">  
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12 date">
                                                        <input type="text"  name="daftar" placeholder="{{ trans('Tarikh Daftar')}}" value="{{ old('daftar') }}" class="form-control" maxlength="25"  />
                                              ...
                                              <div class="row">  
                                                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                      ...
                                                      <div class="col-md-8 col-sm-8 col-xs-12 input-group date">
                                                          <input type="date"  name="keluaran" placeholder="{{ trans('Tarikh Hakmilik Keluaran')}}" value="{{ old('keluaran') }}" class="form-control" maxlength="25" >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">  
                                                <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <textarea rows="10" cols="50" name="kepentingan" placeholder="{{ trans('cth:Geran Kod A dan B')}}" value="{{ old('kepentingan') }}" class="form-control" maxlength="200" ></textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="row">  
                                            <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                                <label class="control-label col-md-9 col-sm-9 col-xs-12" for="display-name">{{ trans('Syarat-Syarat Nyata')}} </label>
                                                <div class="col-md-10 col-sm-10 col-xs-12">
                                                    <input type="file"  name="file" placeholder="{{ trans('Syarat-syarat Nyata')}}" value="{{ old('syarat') }}" class="form-control" maxlength="100" >
                                                    @if ($errors->has('syarat'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('syarat') }}</strong>
                                                    </span>
