                                ...
                                <form id="demo-form2" action="{!! url('/failkes/store')!!}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask customerAddForm">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                        ...
                                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                                            <label class="control-label ">RM :</label><label class="control-label"><input type="text"  name="cukai" placeholder="{{ trans('')}}" value="{{ old('cukai') }}" class="form-control"    ></label>
                                                            @if ($errors->has('cukai'))
                                                            <span class="help-block text-danger" autofocus>
                                        ...
                                        <div class="card-body">
                                            <div class="row">  
                                                <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <input type="file" id="file" name="file" placeholder="{{ trans('Syarat-syarat Nyata')}}" value="{{ old('file') }}"  >
                                                        @if ($errors->has('file'))
                                                        <span class="help-block text-danger" autofocus>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                            ...
                                            <button type="submit" id="sub-btn" class="btn btn-success customerAddSubmitButton">{{ trans('Submit')}}</button>
                                        </div>
                                    </div>
