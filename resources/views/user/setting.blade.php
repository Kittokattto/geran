				...
				<div class="col-md-12 col-sm-12 col-xs-12" >
					...
					<div class="card mb-4 py-3 border-bottom-secondry">
						...
						<nav class="tab-link" style="margin-left: 8px;" >
							...
							<a href="{!! url('/user/setting')!!}" class="d-none d-sm-inline-block btn btn-sm btn-outline-primary shadow-sm"><span class="visible-xs"></span><i class="fa">&nbsp;</i><b>Tetapan Maklumat</b></a>
                            ...
                            <div class="col-md-9">
                                <div class="card" style="margin:50px 0px 0px -50px; ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="update1/{{ $user->id }}">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    {{-- <input id="role" type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="{{ old('department') }}" required autocomplete="name" autofocus> --}}
                                                    <select disabled name="role" id="role" class="form-control @error('role') is-invalid @enderror"  placeholder="{{$user->role}}" required autocomplete="role" autofocus>
